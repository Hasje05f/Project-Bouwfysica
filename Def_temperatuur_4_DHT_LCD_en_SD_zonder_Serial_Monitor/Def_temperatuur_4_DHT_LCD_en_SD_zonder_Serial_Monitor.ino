...
void setup() { 
 ...
 // Serial.begin(9600);                                                                                     // Initialize the serial connection at 9600 bits per second.
  ...
  if (!SD.begin(CHIPSELECT)) {                                                                              // Check presence SD-card
...
//    Serial.println(dataFile);
 ...
 /*                                                                                                       // Check function DHT's 
 
    if (1==1)                                                                                                               //Idrk how to check
...
void loop() { 
  ...
  delay(EDELAY);                                                                                          // Request temperature values DHT
 ...
 /*                                                                                                       // Serial.print temperature values DHT
    delay(EDELAY);  
 ...
 */
 ...
 /*                                                                                                       // Request temperature value PT100 
    delay(EDELAY); 
 ...
 */
 ...
 /*                                                                                                       // Serial.print temperature value PT100 
    delay(EDELAY); 
 ...
 */
  ...
  delay(EDELAY);                                                                                          // Request humidity values DHT
 ...
 /*                                                                                                       // Serial.print humidity values DHT 
    delay(EDELAY); 
 ...
 */
  ...
  case 2:                             // Binnenmuur/isolatie (interior wall/insulation)
 	      lcd.setCursor(0,0);           // Print previous pieces of info on the LCD
